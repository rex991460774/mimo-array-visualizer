...
class VirtualArrayGui:
    ...
    def __init__(self, root: tk.Tk) -> None:
        ...
        root.grid_rowconfigure(2, weight=1, minsize=480)
        ...
        style.configure(
            "WorkspaceHidden.TNotebook",
            background=THEME["panel_bg"],
            borderwidth=0,
            tabmargins=(0, 0, 0, 0),
        )
        style.layout("WorkspaceHidden.TNotebook.Tab", [])
        style.configure(
            "Eval.TNotebook.Tab",
            background=THEME["panel_bg"],
            foreground=THEME["text_secondary"],
        ...
        main_panel.grid_columnconfigure(0, weight=7)
        main_panel.grid_columnconfigure(1, weight=0, minsize=300)
        main_panel.grid_rowconfigure(0, weight=0)
        main_panel.grid_rowconfigure(1, weight=1)

        main_tab_strip = ttk.Frame(main_panel, style="Panel.TFrame")
        main_tab_strip.grid(row=0, column=0, sticky="w", padx=(0, 10), pady=(0, 6))

        self.main_notebook = ttk.Notebook(main_panel, style="WorkspaceHidden.TNotebook")
        ...
        overview_panel = ttk.Frame(main_panel, style="Panel.TFrame", padding=(0, 2, 0, 2))
        overview_panel.grid(row=0, column=1, rowspan=2, sticky="nsew")
        ...
        self.main_notebook.add(tab1, text="  Physical & Virtual  ")
        ...
        self.main_notebook.add(tab2, text="  1D DBF  ")
    ...
    def _build_app_menu(self, parent: tk.Widget) -> None:
        menu_bar = ttk.Frame(parent, style="AppMenu.TFrame", padding=(16, 10, 18, 10))
        menu_bar.grid(row=0, column=0, columnspan=3, sticky="ew")
        menu_bar.grid_columnconfigure(8, weight=1)

        self.app_logo_image = self._load_logo_image(APP_LOGO_UI_PATH)
        logo_kwargs = (
            {"image": self.app_logo_image}
            if self.app_logo_image is not None
            else {"text": "MAV"}
        )
        ttk.Label(
            menu_bar,
            style="AppLogo.TLabel",
            anchor="center",
            **logo_kwargs,
        ).grid(row=0, column=0, sticky="w", padx=(0, 10))

        self.app_brand_label = ttk.Label(
            menu_bar,
            text=self._t("app_name"),
            style="AppBrand.TLabel",
            anchor="w",
        )
        self.app_brand_label.grid(row=0, column=1, sticky="w", padx=(0, 14))

        ttk.Label(
            menu_bar,
            text="|",
            style="AppSeparator.TLabel",
            anchor="center",
        ).grid(row=0, column=2, sticky="w", padx=(0, 14))

        menu_specs = (
            ("config_menu_button", "config_menu", "menu_file", 3),
            ("edit_menu_button", "edit_menu", "menu_edit", 4),
            ("language_menu_button", "language_menu", "menu_view", 5),
            ("help_menu_button", "help_menu", "menu_help", 6),
        )
    ...
    def _build_main_tab_strip(
        ...
        for column, (index, label) in enumerate(tabs):
            button = ttk.Button(
                parent,
                text=label,
    ...
    def _build_workspace_header(self, parent: tk.Widget) -> None:
        ...
        title_group.grid(row=0, column=0, sticky="w", padx=(0, 18))
        ...
        chip_row.grid(row=0, column=1, sticky="ew")
        chip_specs = (
    ...
    def _build_angle_metric_group(
        ...
        for row, (metric_key, label_key) in enumerate(metric_specs, start=1):
            ...
            name_label.grid(row=row, column=0, sticky="w", pady=(0, 1), padx=(0, 2))
            value_label = ttk.Label(
                group,
                text="",
                style="MetricValue.TLabel",
            ...
            value_label.grid(row=row, column=1, sticky="e", pady=(0, 1))
    ...
    def _build_evaluation_panel(self, parent: ttk.Frame) -> None:
        ...
        self.overview_frame.grid(row=0, column=0, sticky="ew", pady=(0, 4))
